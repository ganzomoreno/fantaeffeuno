...
// ─── PENALITÀ MANUALI (registro permanente) ──────────────────────────────────
// Deduzioni di punti decise dall'admin (es. mancato schieramento in tempo).
// Vengono sottratte dal totale stagionale (lib/scoring.calculateTeamScores)
// e mostrate in Classifica. Match per nome squadra. NON rimuovere righe storiche.
export const PENALTIES = [
  { team: "Abdull Mazzar", calendarIndex: 14, location: "Monaco", points: 5, reason: "Mancato schieramento in tempo" },
];
...
export const CALENDAR = [
  ...
  { date:"14/03/2026", type:"sprint",  location:"Cina" },
  ...
  { date:"12/04/2026", type:"race",    location:"Bahrain", cancelled:true },
  { date:"13/04/2026", type:"auction", location:"Asta" },
  { date:"19/04/2026", type:"race",    location:"Arabia Saudita", cancelled:true },
  { date:"02/05/2026", type:"sprint",  location:"Miami" },
  { date:"03/05/2026", type:"race",    location:"Miami" },
  { date:"02/05/2026", type:"auction", location:"Asta" },
  { date:"23/05/2026", type:"sprint",  location:"Canada" },
  { date:"24/05/2026", type:"race",    location:"Canada" },
  { date:"31/05/2026", type:"auction", location:"Asta" },
  { date:"07/06/2026", type:"race",    location:"Monaco" },
  { date:"14/06/2026", type:"race",    location:"Spagna (Barcellona)" },
  { date:"21/06/2026", type:"auction", location:"Asta" },
  { date:"28/06/2026", type:"race",    location:"Austria" },
  { date:"04/07/2026", type:"sprint",  location:"Gran Bretagna" },
  { date:"05/07/2026", type:"race",    location:"Gran Bretagna" },
  { date:"12/07/2026", type:"auction", location:"Asta" },
  { date:"19/07/2026", type:"race",    location:"Belgio" },
  { date:"26/07/2026", type:"race",    location:"Ungheria" },
  { date:"09/08/2026", type:"auction", location:"Asta" },
  { date:"22/08/2026", type:"sprint",  location:"Paesi Bassi" },
  { date:"23/08/2026", type:"race",    location:"Paesi Bassi" },
  { date:"06/09/2026", type:"race",    location:"Italia" },
  { date:"09/09/2026", type:"auction", location:"Asta" },
  { date:"13/09/2026", type:"race",    location:"Spagna (Madrid)" },
  { date:"26/09/2026", type:"race",    location:"Azerbaijan" },
  { date:"03/10/2026", type:"auction", location:"Asta" },
  { date:"10/10/2026", type:"sprint",  location:"Singapore" },
  { date:"11/10/2026", type:"race",    location:"Singapore" },
  { date:"25/10/2026", type:"race",    location:"Stati Uniti" },
  { date:"29/10/2026", type:"auction", location:"Asta" },
  { date:"01/11/2026", type:"race",    location:"Messico" },
  { date:"08/11/2026", type:"race",    location:"Brasile" },
  { date:"13/11/2026", type:"auction", location:"Asta" },
  { date:"21/11/2026", type:"race",    location:"Las Vegas" },
  { date:"29/11/2026", type:"race",    location:"Qatar" },
  { date:"02/12/2026", type:"auction", location:"Asta" },
  { date:"06/12/2026", type:"race",    location:"Abu Dhabi" },
];

// ─── OFFICIAL F1 RACING NUMBERS ──────────────────────────────────────────────
export const F1_PILOT_NUMBERS = {
  NOR: 4,  PIA: 81, RUS: 63, ANT: 12,
  VER: 1,  HAD: 6,  LEC: 16, HAM: 44,
  ALB: 23, SAI: 55, LIN: 45, LAW: 30,
  ALO: 14, STR: 18, OCO: 31, BEA: 87,
  HUL: 27, BOR: 5,  GAS: 10, COL: 43,
  PER: 11, BOT: 77,
};
